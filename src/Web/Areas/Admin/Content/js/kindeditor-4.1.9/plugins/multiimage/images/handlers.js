function att_show(serverData, file) {
    ...
    if (ext == "jpg" || ext == "jepg" || ext == "gif" || ext == "png" || ext == "bmp") {
        var img = '<a href="javascript:;" onclick="javascript:att_cancel(this,' + id + ',\'upload\')" class="on"><div class="icon"></div><img src="' + src + '" width="80" imgid="' + id + '" path="' + src + '"/></a>';
    } else {
        var img = '<a href="javascript:;" onclick="javascript:att_cancel(this,' + id + ',\'upload\')" class="on"><div class="icon"></div><img src="/areas/admin/content/images/ext/' + ext + '.png" width="80" imgid="' + id + '" path="' + src + '"/></a>';
    }
    $.get('index?m=attachment&c=attachments&a=swfupload_json&aid=' + id + '&src=' + src);
