...
namespace ElFinder
{
    internal static class Mime
    {
        ...
        static Mime()
        {
            ...
            if (assembly != null)
            {
                string fullName = System.Web.HttpContext.Current.Server.MapPath("~") + "lib\\mimeTypes.txt";
                using (StreamReader reader = new StreamReader(fullName, System.Text.Encoding.Default))
                {
