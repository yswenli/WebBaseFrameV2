//------------------------------------------------------------------------------
// <auto-generated>
//     此代码由WEF.ModelGenerator, Version=4.0.0.0, Culture=neutral, PublicKeyToken=null生成;时间 2018-11-12 14:37:15.975
...
namespace WebBaseFrame.Models
{
	...
	public partial class AreaRepository
	{
		...
		/// 当前实体查询上下文
		/// </summary>
		public ISearch<Area> Search(string tableName="")
		{
		...
		/// 当前实体查询上下文
		/// </summary>
		public ISearch<Area> Search(Area entity)
		{
				return db.Search<Area>(entity);
		}
		/// <summary>
		/// 构造方法
		/// </summary>
		...
		/// </summary>
		public int Deletes(List<Area> objs)
		{
			return db.Delete<Area>(objs);
		}
		/// <summary>
		/// 执行sql语句
