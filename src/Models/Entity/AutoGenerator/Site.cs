//------------------------------------------------------------------------------
// <auto-generated>
//     此代码由WEF.ModelGenerator, Version=4.0.0.0, Culture=neutral, PublicKeyToken=null生成;时间 2018-11-12 14:37:16.618
...
namespace WebBaseFrame.Models
{
	...
	public partial class SiteRepository
	{
		...
		/// </summary>
		public int Deletes(List<Site> objs)
		{
			return db.Delete<Site>(objs);
		}
		/// <summary>
		/// 执行sql语句
